...
# Improvement ideas:
# - Use a session for Cloudflare requests to avoid throttling/blocking
...
input_file="/home/etrask/code/scripts/cf_update/cloudflare_settings.json"
...
if not path.isfile(input_file):
    ...
    fd.close()
    print("Successfully loaded "+col.B+input_file+col.C)
...
with requests.Session() as s:
    for zone in cloudflare_settings["zones"]:
        ...
        #api_token=zone["api_token"]i
        #token_header={"Authorization":"Bearer "+api_token}
        ...
        if not r_token_verification["success"]:
            ...
            continue
        print("The provided Cloudflare API token is a valid, active token...")
